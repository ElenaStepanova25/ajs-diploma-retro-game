...
export default class GamePlay {
  ...
  redrawPositions(positions) {
    this.cells.forEach((cell) => {
      const cellElement = cell; // Создаем новую переменную, чтобы избежать no-param-reassign
  ...
  deselectCell(index) {
    if (typeof index === 'number') {
      ...
      const classesToRemove = Array.from(cell.classList).filter((o) => o.startsWith('selected'));
